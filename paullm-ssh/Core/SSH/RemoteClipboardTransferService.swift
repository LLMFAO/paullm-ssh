...
actor RemoteClipboardTransferService {
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "paullm-ssh", category: "RemoteClipboardTransfer")
    ...
    private func scheduleStaleFileSweepIfNeeded(using sshClient: SSHClient) {
        ...
        Task(priority: .utility) {
            let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "paullm-ssh", category: "RemoteClipboardTransfer")
