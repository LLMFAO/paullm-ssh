...
actor SSHClient {
    ...
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "paullm-ssh", category: "SSH")
...
actor SSHSession {
    ...
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "paullm-ssh", category: "SSHSession")
