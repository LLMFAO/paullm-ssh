...
struct ProUpgradeSheet: View {
    ...
    var body: some View {
        ...
        NavigationStack {
            iosSheetContent
                .navigationTitle("paullm-ssh Pro")
    ...
    private var iosSheetContent: some View {
        ...
        .manageSubscriptionsSheetCompat(
            ...
            subscriptionGroupID: paullm-sshProducts.subscriptionGroupId
        )
        #endif
    }
    ...
    private var subscribeButtonTitle: String {
        ...
        if product.id == paullm-sshProducts.proLifetime {
    ...
    private func handlePurchaseStateChange(_ newState: PurchaseState) {
        ...
        case .purchased:
            ...
            if storeManager.lastPurchasedProductId == paullm-sshProducts.proLifetime,
