...
final class AppLockManager: ObservableObject {
    ...
    func requestSetFullAppLockEnabled(_ enabled: Bool) async {
        ...
        let reason = String(format: String(localized: "Enable %@ for paullm-ssh"), biometryDisplayName)
    ...
    func ensureAppUnlocked() async -> Bool {
        ...
        let reason = String(format: String(localized: "Unlock paullm-ssh with %@"), biometryDisplayName)
